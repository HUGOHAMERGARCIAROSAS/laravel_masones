...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">La francmasonería</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Inicio</a></li>
                        <li class="breadcrumb-item active">La francmasonería</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card card-outline card-info">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-5">
                                <div class="form-group">
                                    <img src="{{ asset('admin_template/img/francmasoneria/' . $francmasoneria->images) }}"  class="img-fluid"/>
                                </div>
                            </div>
                            <div class="col-sm-1">
                            </div>
                            <div class="col-sm-6">
                                <form action="{{route('administracion.francmasoneria.descripcion.actualizar')}}" method="POST">
                                    @csrf
                                    <div class="form-group">
                        ...
                        <form action="{{ route('administracion.francmasoneria.imagenes.subir') }}" method="POST" class="dropzone" id="mi-dropzone" enctype="multipart/form-data">
                            @csrf
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/dropzone/5.9.3/dropzone.min.js"></script>
    ...
    <script>
        Dropzone.options.miDropzone = {
            url: "{{ route('administracion.francmasoneria.imagenes.subir') }}", 
            maxFiles: 1,
            maxFilesize: 10,
            acceptedFiles: 'image/*',
