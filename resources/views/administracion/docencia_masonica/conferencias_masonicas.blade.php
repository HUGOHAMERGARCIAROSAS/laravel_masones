    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Conferencias Masonicas</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Inicio</a></li>
                            <li class="breadcrumb-item active">Conferencias Masonicas</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="col-md-12">
                    <div class="card card-outline card-info">
                        ...
                        <div class="card-body">
                            <form action="{{ route('administracion.conferencias_masonicas.actualizar') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                ...
                <div class="col-md-12">
                    <div class="card card-outline card-info">
                        ...
                        <div class="card-body">
                            <form action="{{ route('administracion.conferencias_masonicas.storeLinks') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                ...
                                <div class="col-12">
                                   <div class="table-responsive">
                                       <table id="example1" class="table table-bordered table-striped">
                                           ...
                                           <tbody>
                                           @foreach($detalle_conferencias_masonicas as $key => $link)
                                               <tr>
                                                   <td>{{ $key+1 }}</td>
                                                   <td>{{ $link->link }}</td>
                                                   <td>{{ $link->detalle }}</td>
                                                   <td class="text-center">
                                                       <form action="{{ route('administracion.conferencias_masonicas.destroyLinks', $link->id) }}" method="POST">
                                                           @csrf
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('administracion.conferencias_masonicas.updateLinks', $link->id) }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
