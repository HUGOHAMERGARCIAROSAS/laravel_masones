    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Logias</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Inicio</a></li>
                            <li class="breadcrumb-item active">Logias</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group text-center">
                                        <img src="{{ asset('admin_template/img/red_logias/' . $logia['0']->imagen) }}"
                                            width="200" height="200" alt="Imagen">
                                    </div>
                                </div>
                                <form action="{{ route('administracion.red_logias.update', $logia['0']->id) }}"
