    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Revistas Masonicas</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Inicio</a></li>
                            <li class="breadcrumb-item active">Revistas Masonicas</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="col-md-12">
                    <div class="card card-outline card-info">
                        ...
                        <div class="card-body">
                            <form action="{{ route('administracion.revistas_masonicas.actualizar') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="link" id="link"
                                                required value="{{ $revistas_masonicas->link }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
