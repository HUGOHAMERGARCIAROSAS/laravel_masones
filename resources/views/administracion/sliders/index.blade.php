                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group text-right">
                                        <a href="{{ route('administracion.sliders.crear') }}"
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">Listado de Sliders</h3>
                                        </div>
                                        <div class="card-body">
                                                ...
                                                <tbody>
                                                    @foreach ($sliders as $key => $item)
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="{{ route('administracion.sliders.editar', $item->id) }}"
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <form id="delete-form-{{ $item->id }}"
                                                                    action="{{ route('administracion.sliders.destroy', $item->id) }}"
