                ...
                <div class="col-md-12">
                    <div class="card card-outline card-info">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        <img src="{{ asset('admin_template/img/nosotros/' . $nosotros->images) }}"
                                            class="img-fluid" />
                                    </div>
                                </div>
                                <div class="col-sm-1">
                                ...
                                <div class="col-sm-6">
                                    <form action="{{ route('administracion.nosotros.descripcion.actualizar') }}"
                                        method="POST">
                                        @csrf
                                        <div class="form-group">
                            ...
                            <form action="{{ route('administracion.nosotros.imagenes.subir') }}" method="POST"
                                class="dropzone" id="mi-dropzone" enctype="multipart/form-data">
                                @csrf
                                <div class="dz-message" data-dz-message><span>Arrastra y suelta una imagen aquí o haz clic
                                        para subir</span></div>
                            </form>
                        </div>
                        </form>
