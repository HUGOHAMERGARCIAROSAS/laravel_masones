...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin_template/css/tempusdominus-bootstrap-4.min.css') }}">
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ asset('admin_template/css/icheck-bootstrap.min.css') }}">
    <!-- JQVMap -->
    <link rel="stylesheet" href="{{ asset('admin_template/css/jqvmap.min.css') }}">
    <!-- Theme style -->
    <link rel="stylesheet" href="{{ asset('login_template/css/adminlte.css') }}">
    <!-- overlayScrollbars -->
    <link rel="stylesheet" href="{{ asset('admin_template/css/OverlayScrollbars.min.css') }}">
    <!-- Daterange picker -->
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <!-- ChartJS -->
    <!-- Sparkline -->
    {{-- <script src="{{ asset('admin_template/js/sparkline.js')}}"></script> --}}
    <!-- JQVMap -->
    {{-- <script src="{{ asset('admin_template/js/jquery.vmap.min.js')}}"></script>
    <script src="{{ asset('admin_template/js/jquery.vmap.usa.js')}}"></script>
    <!-- jQuery Knob Chart -->
    <script src="{{ asset('admin_template/js/jquery.knob.min.js')}}"></script>
    <!-- daterangepicker -->
    
    <script src="{{ asset('admin_template/js/daterangepicker.js')}}"></script>
    <!-- Tempusdominus Bootstrap 4 -->
    <script src="{{ asset('admin_template/js/tempusdominus-bootstrap-4.min.js')}}"></script>--}}
    <!-- Summernote -->
    <script src="{{ asset('admin_template/js/jquery.knob.min.js')}}"></script>
    <script src="{{ asset('admin_template/js/daterangepicker.js')}}"></script>
    ...
    <!-- overlayScrollbars -->
    <script src="{{ asset('admin_template/js/jquery.overlayScrollbars.min.js')}}"></script>
    <!-- AdminLTE App -->
