            ...
            <div class="row g-4 mb-5">
                <div class="col-lg-8 col-xl-9">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            <h1 class="fw-bold mb-3 text-primary">{{ $logia[0]->titulo }}</h1>
                            <p class="mb-3">Fecha: {{ $logia[0]->fecha }}</p>
                            <p class="mb-4">
                                {!! $logia[0]->descripcion !!}
                            </p>
                        </div>
                                ...
                                <div class="d-flex align-items-center justify-content-start">
                                    <div class="rounded" style="width: 100px; height: 100px;">
                                        <a href="{{ route('detalle.eventos', $item->id) }}">
                                            <img src="{{ asset('admin_template/img/eventos/' . $item->imagen) }}"
                                                class=" rounded" alt="Image" width="80" height="80">
                                        </a>
                                    </div>
                                    <div>
                                        <a href="{{ route('detalle.eventos', $item->id) }}">
                                            <h6 class="mb-2 text-primary">{{ $item->titulo }}</h6>
                                        </a>
